...
export default function AdminProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    // console.log(e.target.value + " " + section.id + " " + option.value);
  };
              ...
              <div className="lg:col-span-3 ">
                <div className="mt-6 mb-10">
                  <Link
                    ...
                    className="rounded-md mt-10 mx-10 my-5 bg-green-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Add New Product
                  </Link>
                </div>
...
function DekstopFilter({ handleFilter, filters }) {
  return (
        ...
        <div className="mt-1 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {products.map((product) => (
            <div>
              ...
              >
                <div className="group relative border-2 border-gray-300 p-2">
